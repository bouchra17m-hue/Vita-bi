          ...
          <div className="container hero-premium-container">
            <div className="hero-premium-copy" style={{ maxWidth: '45rem' }}>
              ...
              <p style={{ 
                ...
                L'alliance parfaite entre science nutritionnelle, �quipement de pointe et technologie intelligente.
              </p>
          ...
          <div className="container">
            <div className="ecosystem-header reveal-on-scroll">
              <h2 className="ecosystem-title">
                L'�COSYST�ME <span>VITABI</span>
              </h2>
              <p className="ecosystem-subtitle">
                Un �cosyst�me complet pour performer: �quipement, nutrition, analyse et coaching.
              </p>
            </div>
            ...
            <div className="ecosystem-grid">
              ...
              >
                ...
                <div className="premium-card__content">
                  ...
                  <h3>Shop</h3>
                  <p>�quipement premium et accessoires de performance.</p>
                  <div className="premium-card__cta">D�couvrir ?</div>
                </div>
              </Link>
...
to="/calculator"
              ...
              >
                ...
                <div className="premium-card__content">
                  ...
                  <h3>Calculateur</h3>
                  <p>Macros, calories et suivi: pr�cis, simple, efficace.</p>
          ...
          <div className="container">
            <div className="cta-glass reveal-on-scroll">
              <div className="cta-copy">
                <h3>Rejoignez la r�volution fitness.</h3>
                <p>D�bloquez une exp�rience premium: routines, nutrition et coaching.</p>
              </div>
              <div className="cta-metrics">
                ...
                <div className="cta-metric">
                  ...
                  <div className="cta-metric__label">Calories br�l�es</div>
                </div>
              </div>
